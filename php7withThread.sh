...
echo "extension=ev.so" >> /etc/php7/cli/php-cli.ini

echo "zend_extension=opcache.so" >> /etc/php7/cli/php.ini

ln --symbolic -f /etc/php7/bin/php /usr/bin/php

ln --symbolic -f /etc/php7/sbin/php-fpm /usr/sbin/php7-fpm

ln --symbolic -f /etc/php7/bin/phpize /usr/sbin/phpize
